...
Im **Katalog** finden Sie alle Kurse, Lernprogramme und Zertifizierungen, die im Unternehmenskonto für eine Teilnehmerrolle verfügbar sind.

Teilnehmer können im **Standardkatalog** alle zugewiesenen und verfügbaren Lernobjekte (Lernprogramme, Kurse und Zertifizierungen) sehen. Diese Lernobjekte sind für jeden Teilnehmer basierend auf seiner Rolle, Einstufung, Benutzergruppe, seinem Profil usw. einzigartig.
...
Oben auf der Seite können Sie im Suchbereich die Namen Ihrer bekannten Lernobjekte eingeben. Teilnehmer können zwischen dem Raster und der Listenansicht wechseln, indem sie dieses Symbol ![](assets/icon-list.png) auswählen.
...
2. **[!UICONTROL Schnittstellensprache]**: Kurse in der Sprache der Benutzeroberfläche werden als Nächstes aufgeführt.
...
2. **[!UICONTROL Kontosprache]**: Wenn die Browsersprache nicht verfügbar ist, wird die Sprache des ALM-Kontos berücksichtigt.
3. **[!UICONTROL Standard für Englisch]**: Wenn der Browser oder die Kontosprache nicht verfügbar ist, werden die Kurse in englischer Sprache angezeigt.

Wählen Sie in der Teilnehmer-App die Seite **[!UICONTROL Kataloge]** und dann Ihre bevorzugte Sortieroption aus: **[!UICONTROL Name (A-Z)]** oder **[!UICONTROL Name (Z-A)]**. Die Kurse werden entsprechend Ihrer ausgewählten Sortiervoreinstellung angezeigt, wobei sprachbasierte Priorisierung angewendet wird.