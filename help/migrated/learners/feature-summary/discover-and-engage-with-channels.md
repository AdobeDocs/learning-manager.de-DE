...
1. Wählen Sie in der oberen Navigationsleiste **Kanäle** aus.
   ...
   ![Register &quot;Alle Kanäle&quot;](assets/channels-page-all-tab.png)
...
1. Wählen Sie die Schaltfläche **Abonnieren**.
   ...
   <br> Der Kanal wird der Registerkarte **Abonniert** hinzugefügt.

1. Wählen Sie die Registerkarte **Abonniert**.

   <br> Hiermit werden alle Kanäle angezeigt, die Sie abonniert haben.

   ![Liste der abonnierten Kanäle](assets/subscribed-channels-list.png)
...
![Registerkarte &quot;Geeignete Videos&quot;](assets/liked-videos-tab.png)
...
1. Wählen Sie **Post** aus.
   ...
   <br> Der Kommentar wird dem Diskussionsthread hinzugefügt und ist für andere Teilnehmer, die das Video anzeigen, sichtbar.

   ![Videokanaldiskussion](assets/channel-video-discussion.png)
