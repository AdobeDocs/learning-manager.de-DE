...
1. Um die Änderungen zu speichern, klicken Sie auf **[!UICONTROL Speichern]**. Um den Kurs zu veröffentlichen, klicken Sie auf **[!UICONTROL Veröffentlichen]**.
...
1. Wählen Sie, ob Sie einen Preis für Ihren Kurs festlegen oder ihn kostenlos anbieten möchten. Wenn Sie den Kurs kostenpflichtig anbieten möchten, wählen Sie die Option **[!UICONTROL Kostenpflichtig]** und geben Sie einen Preis an. Der Preis wird Teilnehmenden dann auf der Kurskarte und der Kursübersichtsseite angezeigt.
...
![Seite &quot;Planungsassistent&quot;](assets/scheduling-assistant-window.png)
...
![Kursleiter nach Namen suchen](assets/search-instructor.png)
...
![Kenntnisse für den Kursleiter eingeben](assets/scheduling-assistant-instructor-skill.png)
...
![Terminplaner](assets/scheduling-assistant-2.png)
...
![Planungsassistent über die Instanzseite](assets/instances-scheduling.png)
...
![Überprüfen ausstehender Checklistenüberprüfungselemente](assets/evaluation-checklist.png)
...
Autoren können Kurse sortieren, um den gewünschten Kurs schneller zu finden. Klicken **[!UICONTROL Sortieren]** und wählen Sie alphabetisch aufsteigende Reihenfolge, alphabetisch absteigende Reihenfolge, Erstellungsdatum des Kurses, Aktualisierungsdatum des Kurses und Kurseffektivität.
