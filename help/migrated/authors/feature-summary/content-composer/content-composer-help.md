...
## In wenigen Minuten vom Konzept zum Kurs.
...
**[Content Composer →](https://contentcomposer.adobe.io/)** testen
 ...
 <tbody>
  <tr>
   <td style="border:none;">
    ...
    <img alt="Erste Schritte mit Content Composer" src="../assets/cc-get started.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="what-is-content-composer.md"><strong>Erste Schritte mit Content Composer</strong></a>
    </div>
    <p>Was Content Composer ist, für wen es gedacht ist und was Sie benötigen, bevor Sie beginnen.</p>
   </td>
   <td style="border:none;">
    <a href="write-a-prompt.md">
    <img alt="Kurs erstellen" src="../assets/cc-create-course.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="write-a-prompt.md"><strong>Kurs erstellen</strong></a>
    </div>
    <p>Wechseln Sie in einem einzigen Assistenten von einer einfachen Eingabeaufforderung zu einem Kurs, der für die Veröffentlichung bereit ist.</p>
   </td>
   <td style="border:none;">
    <a href="general-course-settings.md">
    <img alt="Kurseinstellungen konfigurieren" src="../assets/cc-course-settings.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="general-course-settings.md"><strong>Kurseinstellungen konfigurieren</strong></a>
    </div>
    <p>Legen Sie vor der Veröffentlichung Abschlusskriterien, die Quizpunktzahl und Ihre Adobe Learning Manager-Verbindung fest.</p>
   </td>
  </tr>
  <tr>
   <td style="border:none;">
    <a href="apply-theme.md">
    <img alt="Verwalten von Kursthemen" src="../assets/cc-branding.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="apply-theme.md"><strong>Kursthemen verwalten</strong></a>
    </div>
    <p>Wenden Sie visuelle Themen an, passen Sie sie an, erstellen und importieren Sie sie, um zu steuern, wie Ihr Kurs aussieht und sich anfühlt.</p>
   </td>
   <td style="border:none;">
    <a href="share-collaborate.md">
    <img alt="Freigabe und Zusammenarbeit" src="../assets/cc-share.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="share-collaborate.md"><strong>Freigabe und Zusammenarbeit</strong></a>
    </div>
    <p>Teilen Sie Ihren Kurs zur Überprüfung mit Kollegen oder geben Sie Teilnehmern direkten Zugriff auf den Kurs.</p>
   </td>
   <td style="border:none;">
    <a href="publish-to-alm.md">
    <img alt="Veröffentlichen in Adobe Learning Manager" src="../assets/cc-publish-alm.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
 ...
 <tbody>
  <tr>
   <td style="border:1px solid transparent;">
    ...
    <img alt="Beta-Einschränkungen" src="../assets/cc-limitations.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="content-composer-beta-limitations.md"><strong>Beta-Einschränkungen</strong></a>
    </div>
    <p>Eine vollständige Liste der aktuellen Einschränkungen, Problemumgehungen und des Status der Roadmap. Wird aktualisiert, wenn Funktionen ausgeliefert werden.</p>
   </td>
   <td style="border:1px solid transparent;">
    <a href="content-composer-faq.md">
    <img alt="Content Composer - Häufige Fragen" src="../assets/cc-faq.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="content-composer-faq.md"><strong>Häufige Fragen zu Content Composer</strong></a>
    </div>
    <p>Schnelle Antworten auf die häufigsten Fragen zu Authoring, Einstellungen, Freigabe und Veröffentlichung.</p>
   </td>
   <td style="border:1px solid transparent;">
    <a href="theme-json-reference.md">
    <img alt="Referenz zur Theme JSON-Eigenschaft" src="../assets/cc-theme-ref.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="theme-json-reference.md"><strong>Referenz für Theme-JSON-Eigenschaft</strong></a>
    </div>
    <p>Jede Eigenschaft im Content Composer-Design-JSON-Schema mit Beschreibungen und Beispielwerten.</p>
   </td>
  </tr>
 </tbody>
</table>
