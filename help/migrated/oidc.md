...
* Nachdem Sie sich authentifiziert haben, erhält Adobe Learning Manager die Informationen, die Ihr Unternehmen zulässt (z. B. Ihre E-Mail- und Profilattribute), und öffnet das richtige Erlebnis für Sie: Teilnehmer, Autor, Administrator oder andere Rollen, die Ihr Konto unterstützt.
...
* OIDC folgt Mustern, die anderen modernen Anmelde-Flows von einem Benutzer und einer IT-Perspektive ähneln, ohne dass der Austausch von Dokumenten aufwändiger ist, wenn nur SAML-Konfigurationen verwendet werden.

Ihre Erfahrung ist noch nicht abgeschlossen: Öffnen Sie den Learning Manager, melden Sie sich an, wo Ihr Unternehmen es Ihnen sagt, und landen Sie in der App.
...
Geben Sie auf der Seite Ihres Identitätsanbieters Ihre Anmeldeinformationen ein und führen Sie alle zusätzlichen Schritte aus, die Ihre Organisation benötigt, z. B. die Multi-Faktor-Authentifizierung. Dieser Schritt erfolgt außerhalb des Anmeldeformulars von Adobe Learning Manager, wenn OIDC verwendet wird. Von Ihrer Perspektive aus hat man das Gefühl, bei Ihrem Firmen- oder Bildungseinrichtungskonto angemeldet zu sein. Möglicherweise werden in diesem Schritt keine technischen Begriffe wie *OIDC* oder *OAuth* angezeigt.
...
| Identifizierung-basierte Anmeldung | Wenn Ihr Konto (abgesehen von E-Mails) auf stabilen Identifizierungen für entsprechende Konten basiert, werden diese Flows für OIDC entsprechend der Konfiguration Ihres Administrators unterstützt. |
...
Wenn Sie Adobe Learning Manager für Ihr Unternehmen konfigurieren, wird OIDC mit der Anwendungsregistrierung Ihres Identitätsanbieters eingerichtet: Client-Identifizierungen, Endpunkte für Autorisierung, Token, Benutzerinformationen und die Umleitungs-URL, die Adobe Learning Manager für die vollständige Anmeldung verwendet. Diese Werte stammen aus der Dokumentation Ihres Identitätsanbieters. Die Einstellungen müssen zwischen Ihrem Identitätsanbieter und dem Learning Manager übereinstimmen, damit Benutzer eine reibungslose Umleitung und Rückkehr sehen.
...
* Je nach Kontokonfiguration werden Selbstregistrierung, mehrere SSO-Optionen, Attributaktualisierungen, erstmalige Benutzerbereitstellung, Deep Links, Rückkehrpfad, benutzerdefinierte Domänen, Mobilgeräte, Publish zu Adobe Learning Manager und Übereinstimmung mit Identifizierungen unterstützt.
