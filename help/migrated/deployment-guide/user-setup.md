---
description: Ordnen Sie Benutzer als interne und externe Benutzer an. Interne Benutzer sind Benutzer, die einer bestimmten Organisation oder Gruppe angehören.
jcr-language: en_us
...
1. Wenn Sie externe Profile hinzufügen, werden diese auf der Seite **[!UICONTROL ** Externe Benutzer **(** Administrator **>** Benutzer **>** Externe **) angezeigt.]** Für diese Benutzer werden auch die Höchstzahl der Lizenzen, das Ablaufdatum und die Anmeldeanforderungen angezeigt.
