---
description: Erfahren Sie mehr über die Berichte, die mit der Administratorrolle in der Learning Manager-Anwendung verknüpft sind.
jcr-language: en_us
title: Berichte
...
Erfahren Sie mehr über die Berichte, die mit der Administratorrolle in der Learning Manager-Anwendung verknüpft sind.
...
Der Administrator hat beispielsweise drei Schulungen zur Überwachung der Konformität identifiziert. Learning Manager stellt die Kompatibilitäts-Momentaufnahme für alle drei Schulungen gleichzeitig bereit.
...
Sie können auch den Konformitätsstatus für jedes interne Team anzeigen.
...
Dieser Bericht zeigt die Anzahl der Teilnehmer an, die jeden Monat auf der Lernplattform aktiv sind. Der Benutzer gilt für den Monat als aktiv, wenn er eine der hier genannten Lernaktionen ausführt. Dies ist die gleiche Weise, wie monatlich aktive Einheiten gezählt werden.
...
Dieser Bericht zeigt die Gesamtzahl der Teilnehmer, die in einem Tag oder Monat auf das System zugreifen. Das Durchsuchen der Lernplattform ohne Nutzung des Lernangebots wird auch als &quot;Zugriff&quot; auf die Lernplattform betrachtet. Dies hilft dem Administrator, die Gesamtzahl der Benutzer zu verstehen, die auf das System zugreifen. Am ersten Tag des Monats erstellt Learning Manager einen Datensatz mit allen Benutzern, die im Vormonat auf die Plattform zugegriffen haben. Außerdem werden die Benutzergruppeninformationen für diese Benutzer erfasst.

Nur die vom Administrator konfigurierten Benutzergruppen werden aufgezeichnet. Dadurch können Administratoren auch Filter für Benutzergruppen für historische Monatsdaten anwenden. Beachten Sie, dass für den Fall, dass die Benutzergruppenkonfiguration geändert wurde und der Lern-Manager in früheren Monaten keine Daten für diese Benutzergruppe aufgezeichnet hat, Lern-Manager die Daten für diese neu konfigurierten Benutzergruppen nicht für vorherige Monate anzeigen kann.

Dieser Bericht enthält Benutzer, die mit allen Formaten wie Web, mobiler App, benutzerdefinierten Headless-Lösungen usw. auf die Plattform zugreifen. Im Diagramm zur Verwendung der Geräte-App werden speziell nur die Benutzer erwähnt, die mit der Geräte-App von Learning Manager auf die Plattform zugreifen. Dadurch können Administratoren die Verwendung der mobilen App in ihrem Konto erkennen.
...
Hier sehen Sie zweiachsige Liniendiagramme, die den gesamten Zeitaufwand zum Lernen für alle Teilnehmer über einen Zeitraum von 12 Monaten anzeigen. Die zweite Achse stellt den mittleren Zeitaufwand zum Lernen einer Person dar.
...
Es wird ein Filter zur Auswahl der Benutzergruppenkonfiguration bereitgestellt, der die Anzeige der Daten in Bezug auf verschiedene Benutzergruppen erleichtert.

Der ausgewählte Datums- und Benutzergruppenfilter wird auf alle relevanten Diagramme im Dashboard angewendet.

>[!NOTE]
>
>Für **[!UICONTROL Benutzerbesuche]** und **[!UICONTROL Aufgewandte Lernzeit]** -Berichten werden die Standarddaten (wenn keine Benutzergruppe konfiguriert ist) für das gesamte Konto angezeigt.
...
Dieser Bericht enthält Informationen zu den gesamten Schulungen, die Monat für Monat (im Veröffentlichungszustand) auf der Plattform verfügbar sind. Er informiert über die Anzahl der im Laufe der Zeit angebotenen Schulungen.
...
Bei aktiven Schulungen stehen Daten aller internen Gruppen von Stammbenutzern (mit Managerrolle) zur Auswahl, wenn keine Benutzergruppenkonfiguration vorgenommen wurde. Neben den Stammbenutzergruppen können Sie bei Bedarf 10 weitere Benutzergruppen konfigurieren.
...
Die **[!UICONTROL Beispielberichte]** &quot; einige Musterberichte an, die anhand von Beispieldaten erstellt wurden. Sehen Sie sich diese Berichte an, um zu verstehen, welche funktionsreichen Berichtsvarianten Sie mit Ihren Kontodaten generieren können.

## Dashboard-Berichte {#DashboardReports-1}

Klicken Sie auf diese Dashboard-Registerkarte, um alle von Ihnen erstellten Dashboards anzuzeigen. Im Fenster &quot; **[!UICONTROL Dashboard anzeigen]** können Sie das voreingestellte Board auswählen oder ein Dashboard, das Sie erstellt haben.
...
1. Wenn Sie das Dashboard für einen Manager freigeben möchten, wählen Sie diesen im **[!UICONTROL Freigeben für]** ein. Sie können für diesen Vorgang alle normalen Auswahlkriterien verwenden.
1. Klicken **[!UICONTROL Speichern].**

Sie können das kürzlich erstellte Board im Fenster &quot; **[!UICONTROL Dashboard-Berichte]** &quot; ändern.
...
Freigegebene Dashboards sind eine Sammlung von Berichten, die andere Benutzer in Ihrer Organisation für Sie freigegeben haben. Alle Berichte, die Sie einem freigegebenen Board hinzufügen, werden automatisch für andere Benutzer freigegeben, die Zugriff auf dieses Board haben.
...
* Wählen Sie in der Dropdown-Liste &quot;Dashboard bearbeiten&quot; aus und geben Sie die Benutzerdetails zur Freigabe des Dashboards ein.

>[!NOTE]
>
>Ein Manager kann die Berichte seiner Team-Mitglieder nur über ein freigegebenes Dashboard anzeigen.
...
1. Klicken Sie auf Berichte im linken Bereich. Die Seite mit der Berichtzusammenfassung wird angezeigt.
   ...
   >[!NOTE]
   >
   >Standardmäßig werden mindestens drei Beispielberichte auf der Registerkarte &quot;Beispiel-Board&quot; angezeigt. Sie können die Beispielberichte nur anzeigen, um eine Vorstellung davon zu erhalten, wie Sie sie erstellen und anpassen können.

1. Klicken Sie oben rechts auf der Seite auf **[!UICONTROL Hinzufügen]**.
1. Im Dialogfeld &quot; **[!UICONTROL Bericht hinzufügen]** in der Dropdown-Liste Typ können Sie einen der vordefinierten Berichte auswählen oder **[!UICONTROL Benutzerdefiniert]**. Wenn Sie einen vordefinierten Bericht auswählen, können Sie sehen, dass das Formular bereits ausgefüllt ist. Sie können weitere Änderungen an einigen Feldern vornehmen und auf **[!UICONTROL Speichern]**. Dadurch wird der Bericht zu Ihrem Standard-Dashboard hinzugefügt.

   ![](assets/create-report.png)
   *Bericht erstellen*

   In **[!UICONTROL Berichtstyp]** können Sie einen Satz vordefinierter Berichte oder benutzerdefinierte Werte auswählen. Sie können die folgenden Berichte als Teil einer vordefinierten Gruppe von Berichten anzeigen:
...
1. Wählen Sie die **[!UICONTROL Y-Achse]** für Ihren Bericht aus den Dropdown-Optionen aus. Für einige der ausgewählten Kriterien können Sie einen oder mehrere Status aus den Statusoptionen auswählen. Beispielsweise können für ein primäres Kriterium der Statistik zur Kursregistrierung die Status &quot;Abgeschlossen&quot;, &quot;Nicht abgeschlossen&quot; und &quot;Registriert&quot; lauten. Daten des primären Bereichs werden im Bericht in Form von Balkendiagrammen dargestellt.

   ![](assets/axes-for-reports.png)
   *Achsen für Berichte*

1. Sekundären Bereich auswählen. **[!UICONTROL Y-Achse]** Kriterien/Bereich für Ihren Bericht aus den Dropdown-Optionen. Wählen Sie beispielsweise für eine Option zur Registrierung für ein Lernprogramm einen oder mehrere Status aus dem Status-Dropdown-Menü neben der Option aus. Sekundäre Bereichsdaten werden in Form von Liniendiagrammen dargestellt.
1. Wählen Sie aus den Dropdown-Optionen die für Ihren Bericht geeigneten X**-Achsen**-Kriterien aus. Wenn Sie das Datum als Kriterium für die x-Achse ausgewählt haben, steht eine Option zur Gruppierung des x-Achsen-Kriteriums nach Tag, Monat, Quartal und Jahr zur Verfügung.
1. Wählen Sie im Abschnitt Zeitspanne die entsprechende Option aus dem Dropdown-Menü aus. Folgende Optionen sind verfügbar:
   ...
   * QTD (letzte 90 Tage)
   * YTD (letzte 365 Tage)
   * Datumsbereich. Geben Sie Werte in das Feld **[!UICONTROL Von]** und **[!UICONTROL Funktion]** Datumsfelder.
...
1. **Filterabschnitt**
   ...
   * **Profil:** Wählen Sie die Bezeichnung Ihres Mitarbeiters aus. Dies würde helfen, Berichte von Mitarbeitern basierend auf ihrem Profil/ihrer Einstufung anzuzeigen. Beispiel: Informatiker, Ingenieur.
   ...
   * **Inhalt:** Sie können Ihren Bericht nach Kursen filtern, indem Sie diese in der Dropdownliste auswählen.
   ...
   Erweitern Sie diesen Abschnitt und wählen Sie die erforderlichen Filter aus.
...
Nehmen Sie die erforderlichen Änderungen am Bericht vor. Klicken Sie zum Speichern der Änderungen auf **[!UICONTROL Speichern]**.

## Verschieben eines Berichts in ein Dashboard {#moveareporttoadashboard}

Wählen Sie diese Option, um den aktuellen Bericht in ein vorhandenes Dashboard zu verschieben. Klicken Sie zum Verschieben des Berichts auf die Option **[!UICONTROL Zum Dashboard verschieben]**.
...
## Erstellen einer Kopie eines Berichts {#createacopyofareport}
...
Wählen Sie das Dashboard aus, in das Sie den Bericht kopieren möchten. Klicken Sie auf **[!UICONTROL Kopieren]**.

## Bericht löschen {#deleteareport}

Um einen Bericht zu löschen, wählen Sie die Option **[!UICONTROL Bericht löschen]**. Nachdem Sie den Bericht gelöscht haben, können Sie den Bericht nicht wiederherstellen. Der Vorgang ist unumkehrbar. Gehen Sie beim Löschen eines Berichts mit Vorsicht vor.

![](assets/delete-a-report.png)
*Bericht löschen*

## Bericht herunterladen {#downloadareport}
...
Sie können die Größe Ihrer Berichte ändern in 1×1 (mittel) und 1×2 (groß). So können Sie Ihre Berichte besser anzeigen. Außerdem können Sie diese Berichte einfach schwenken und zoomen.

## Filter {#filters}

Filter werden in **[!UICONTROL Hinzufügen]** am unteren Rand basierend auf Berichtstypen, die Sie ausgewählt haben. Einige der wichtigsten Filter sind unten aufgeführt.
...
Über der Legende für das Diagramm können Sie ein Zoomfeld anzeigen. Bewegen Sie den Cursor darüber, klicken Sie auf den Bereich und ziehen Sie das Kreuzsymbol über einen beliebigen Teil des Zoomfeld-Diagrammbereichs, um ihn zu vergrößern.
...
Um eine Benutzergruppe auszuwählen, geben Sie den Namen der Gruppe ein. Sie können die vorgeschlagenen Gruppen sehen, die entsprechend der eingegebenen Zeichenfolge angezeigt werden. Wenn eine Liste mit Gruppen angezeigt wird, wählen Sie die gewünschte Benutzergruppe aus.

Sie können auch mehrere Benutzergruppen mithilfe der Type-Ahead-Suche auswählen.

Wenn Sie mehrere Benutzergruppen ausgewählt haben, wird nach dem Speichern und Generieren dieses Berichts der Bericht mit allen Benutzergruppen erstellt, die im Balkendiagramm neben jeder x-Achse dargestellt werden.
...
Auf der Seite &quot;Berichte&quot; können Sie alle Berichte anzeigen. Sie können jeden Bericht minimieren, indem Sie auf das Minussymbol (-) in der rechten oberen Ecke jedes Berichts klicken. Klicken Sie auf das Pluszeichen (+), um den Bericht erneut anzuzeigen.

## Schnellansicht mit verschiedenen Datumswerten {#quickviewwithdifferentdates}

Sie können den Datumsbereich/-wert für jeden Bericht ändern und diesen schnell für ein anderes Datum anzeigen, ohne den Bericht zu ändern und zu speichern. Klicken Sie auf das Bearbeitungssymbol (wie in der Abbildung unten mit einem Pfeil gezeigt) neben dem Datumsbereich, z. B. QTD, letztes Jahr. Um die Änderung zu bestätigen, wählen Sie den neuen Wert im Popupmenü und klicken Sie auf das Häkchen. Sie können die Änderung abbrechen, indem Sie auf &quot;X&quot; klicken.

>[!NOTE]
>
>Die Datumswerte, die Sie zum Anzeigen des Berichts verwenden, sind temporär. Wenn Sie die Option &quot;Herunterladen&quot; wählen, wird diese Berichtsansicht nicht heruntergeladen. Diese Ansicht ist nur eine temporäre Ansicht.
...
Wenn Ihnen mehrere Manager unterstellt sind, können Sie die Berichte für jeden Manager schnell anzeigen. Um einen eindeutigen Bericht für jeden Manager anzuzeigen, wählen Sie den Managernamen in der Dropdownliste aus.

>[!NOTE]
>
>Die Managerwerte, die Sie zum Anzeigen des Berichts verwenden, sind temporär. Wenn Sie die Option &quot;Herunterladen&quot; wählen, wird diese Berichtsansicht nicht heruntergeladen. Diese Ansicht ist nur eine temporäre Ansicht.

## Kursberichte anzeigen {#viewcoursereports}

Sie können die für jeden Kurs spezifischen Berichte anzeigen, indem Sie die folgenden Schritte ausführen:

1. Klicken **[!UICONTROL Kursberichte anzeigen]** auf der Registerkarte &quot;Meine Dashboards&quot; auf der Seite &quot;Berichte&quot;.\
   Ein Popup-Dialogfeld wird angezeigt. Es wird ein Texteingabefeld angezeigt, in das Sie den erforderlichen Kurs eingeben können und in der Dropdown-Liste vorgeschlagene Kursnamen angezeigt werden. Wählen Sie den Kurs aus der angezeigten Liste aus.
...
Klicken Sie in der rechten oberen Ecke jedes Berichts auf den Dropdownpfeil, um die Dropdownoptionen für Bearbeiten, Verschieben ins Dashboard, Erstellen einer Kopie, Löschen und Größenänderung anzuzeigen.

![](assets/edit-options-dashboard-300x126.png)

*Berichte bearbeiten/in Dashboard verschieben/Kopie erstellen/löschen/Größe ändern*

**[!UICONTROL Bearbeiten]** Um nach dem Ändern von Daten zu den Anfangswerten zurückzukehren, klicken Sie auf &quot;Zurücksetzen&quot;. Klicken Sie nach dem Ändern der Werte auf &quot;Speichern&quot;.
...
Wenn Sie ein Peer-Konto mit einem anderen Benutzer eingerichtet haben, können Sie die Berichte für dieses Peer-Konto im Fenster &quot; **[!UICONTROL Berichte]** angezeigt. Wenn Sie einen Bericht erstellen, finden Sie die **[!UICONTROL Konto auswählen]** ein. Wählen Sie in der Dropdownliste, in der alle Peer-Konten aufgeführt sind, mit denen Sie verknüpft sind, das Konto aus, für das Sie die freigegebenen Berichte anzeigen möchten.

Wenn beim Erstellen eines Peer-Kontos die Option &quot;Katalog freigeben&quot; nicht aktiviert war, können Sie dieses Peer-Konto nicht in dieser Liste anzeigen.

![](assets/acc1-jpg.png)
*Berichte für Peer-Konten verwalten*

1. Wählen Sie die x- und y-Achse für diesen Bericht aus, und wählen Sie das Datum für diesen Bericht aus.
1. Beachten Sie, dass im Feld &quot;Filter&quot; die Schaltfläche &quot;Freigegebene Kataloge&quot; automatisch aktiviert ist. Dies ist obligatorisch. Wenn die Option &quot;Freigegebener Katalog&quot; nicht aktiviert ist, bedeutet dies, dass Sie keine Berichte für das Peer-Konto erstellen oder anzeigen können.
1. Wählen Sie aus der Dropdown-Liste unter &quot;Freigegebener Katalog&quot; den freigegebenen Katalog, für den Sie den Bericht anzeigen möchten.
1. Klicken [!UICONTROL **Speichern**].
...
1. Wenn Änderungen an dem Katalog von Ihrer Seite vorgenommen werden, spiegeln sich die Änderungen sofort in den vom Peer erstellten Berichten und im Dashboard wider. Wenn der Peer jedoch den Katalog ändert, werden die Änderungen nicht automatisch in Ihrem Dashboard angezeigt.
1. Wenn Sie möchten, dass Ihr Dashboard automatisch aktualisiert wird, muss Ihr Peer Ihnen eine neue Peer-Anforderung senden.
...
In **[!UICONTROL Berichte]** &quot; auf die Schaltfläche  **[!UICONTROL Abonnement]** &quot; ändern. Die Seite zum Abonnieren von Berichten wird angezeigt.
...
Die **[!UICONTROL Excel-Berichte]** &quot; können Sie Berichte im XLS-Dateiformat exportieren.
...
Als Administrator können Sie Berichte für Kurse herunterladen. Führen Sie folgende Schritte aus:

1. Öffnen **[!UICONTROL Berichte]** > **[!UICONTROL Excel-Berichte]** > **[!UICONTROL Kursberichte]**.
1. Die **[!UICONTROL Kursbericht]** &quot; wird angezeigt. Wählen Sie den Kurs aus, von dem Sie den Bericht abrufen möchten, und klicken Sie auf **[!UICONTROL Anzeigen]**.

   ![](assets/course-reports.png)
   *Kursberichte*

1. Sie werden zur Kursseite weitergeleitet. Sie können die Quizpunktzahl nach Benutzer und Frage exportieren, basierend auf jeder Registrierung, indem Sie den spezifischen Registrierungstyp auswählen.
1. Auswählen **[!UICONTROL Quizpunktzahl exportieren]** , um den Bericht zu exportieren. A **[!UICONTROL Erstellen einer Berichtsanforderung]** &quot; wird angezeigt. Klicken **[!UICONTROL OK]** zum Bestätigen.
   ...
   *Erstellen einer Berichtsanforderung*
   ...
   >[!NOTE]
   >
   >Der exportierte Bericht zur Quizpunktzahl enthält die Bewertungsdetails für jeden Versuch, wenn die Option &quot;Mehrere Versuche&quot; für das Modul konfiguriert ist.

## Teilnehmertranskripte {#LearnerTranscripts-1}

Mit dem Adobe-Lernmanager können die Administratoren eines Unternehmens die Transkripte generieren, die mit den Teilnehmern verknüpft sind. Der Teilnehmertranskriptbericht enthält Folgendes:
...
Führen Sie einen der folgenden Schritte aus, um einen Bericht herunterzuladen:

1. Öffnen **[!UICONTROL Berichte]** > **[!UICONTROL Excel-Berichte]** > **[!UICONTROL Bericht für Ankündigungen]**. Die **[!UICONTROL Erstellen einer Berichtsanforderung]** &quot; wird geöffnet. Klicken Sie auf OK.
...
* Öffnen  **[!UICONTROL Berichte]** > **[!UICONTROL Excel-Berichte]** > **[!UICONTROL Arbeitshilfeberichte]**. Die **[!UICONTROL Erstellen einer Berichtsanforderung]** &quot; wird angezeigt. Klicken **[!UICONTROL Ok]**.
* Öffnen **[!UICONTROL Arbeitshilfe]** > **[!UICONTROL Aktionen]** > **[!UICONTROL Bericht exportieren]**.

![](assets/job-aids.png)
*Bericht zu Arbeitshilfen*

* Sie können einen Bericht für eine bestimmte Arbeitshilfe extrahieren, indem Sie auf **[!UICONTROL Bericht exportieren]** unter dem Symbol &quot;Einstellungen&quot;.
...
* Dauer (Minuten)
* Status
* Veröffentlichungsdatum (UTC-Zeitzone)
* Erstellt von Name
* Erstellt per E-Mail
* Erstellt von der eindeutigen Benutzer-ID
* Katalog(e)
* Lernpfad(e)
* Kurse
* Tag(s)
...
* Managername
* Manager-E-Mail
* Eindeutige ID des Managers - Benutzer
* Nach Name zugewiesen
* Per E-Mail zugewiesen
* Eindeutige ID des Benutzers
* Erstellt nach Name
* Erstellt per E-Mail
* Erstellt von Benutzer Eindeutige ID
* Jobcode
* Neues Feld
* Profil
...
Informationen zu Metadaten werden im generierten Bericht nicht abgerufen.

Um einen Kursprüfprotokollbericht zu generieren, führen Sie die folgenden Schritte aus.

1. Auswählen **[!UICONTROL Bericht]** > **[!UICONTROL Excel-Berichte]** > **[!UICONTROL Kursprüfprotokoll]**. Die **[!UICONTROL Inhaltsprüfpfad]** &quot; wird angezeigt.

   ![](assets/course-audit-trial.png)
   *Kursprüfprotokoll*

1. Wählen Sie den Kurs, das Lernprogramm und die Zertifizierung aus, von denen Sie den Bericht herunterladen möchten. Wenn nicht angegeben, werden alle Berichte standardmäßig heruntergeladen.
1. Wählen Sie einen Datumsbereich für den Bericht aus und klicken Sie auf **[!UICONTROL Generieren]**.
1. Der Bericht wird generiert und Sie werden benachrichtigt, dass der Prüfbericht bereit ist. Sie können den Bericht herunterladen.

## Berichte zu Benutzerprüfpfaden {#useraudittrailreports}

Der Benutzerprüfpfad erfasst den Lebenszyklus von Benutzern, Benutzergruppen und Selbstregistrierungsprofilen. Das Hinzufügen, Löschen und Ändern des Managers für Benutzer werden erfasst. Die Erstellung und Löschung von Selbstregistrierungsprofilen werden aufgezeichnet. Sie können die Selbstregistrierung auch anhalten und fortsetzen.
...
1. Das Dialogfeld &quot;Benutzerprüfpfad&quot; wird angezeigt. Wählen Sie den Datumsbereich im Popupmenü. Sie können den Bericht wahlweise für die letzte Woche oder den letzten Monat generieren oder ein benutzerdefiniertes Datum auswählen.
...
Auf der Registerkarte &quot; **[!UICONTROL Bericht zu Benutzerprüfpfaden]** &quot; ändern.
...
1. Klicken  **[!UICONTROL Generieren]** , um den Bericht zu generieren.
   ...
   Nachdem Sie den Bericht eines Teilnehmers erstellt haben, müssen Sie in der Lage sein, die aktuellen und erreichten Informationen für alle Benutzer (intern, extern oder gelöscht) im Konto zu exportieren. Sie können auch die Daten für die von einem Teilnehmer erreichte Stufe überprüfen:

   * Erreichter Bronzedatum
   * Erreichtes Silberdatum
   * Gold erreicht am
   * Platin erreicht am

   Diese Spalten enthalten die Daten, an denen die Stufe zum ersten Mal erreicht wurde. Die Spalte **[!UICONTROL Aktuelle Stufe]** zeigt die aktuelle Stufe des Teilnehmers an.

   Wenn der Administrator die Gamification zurücksetzt, werden alle Punkte des Teilnehmers entsprechend zurückgesetzt.

## Bericht über Registrierung und Aufhebung der Registrierung {#enrollmentandunenrollmentreport}

Administratoren und Manager können einen Bericht der Teilnehmer extrahieren, die sich registriert bzw. ihre Registrierung aufgehoben haben. Als Administrator können Sie alle Teilnehmer, Administrator oder Manager sehen, die von einer Instanz eines Kurses, eines Lernprogramms oder einer Zertifizierung registriert wurden oder deren Registrierung aufgehoben wurde und Sie können den Bericht exportieren. Als Manager können Sie jedoch nur einen Bericht Ihrer Teammitglieder abrufen. Als Manager können Sie nicht die gelöschten Teilnehmer oder Ihren eigenen Namen in der Manager-Anwendung als registrierter oder nicht registrierter Teilnehmer sehen.
...
* Schulungen in den ausgewählten Katalogen (maximal 5) - (Katalogauswahl ist bis zu fünf Katalogen verfügbar)
...
Wählen Sie im folgenden Dialogfeld den Datumsbereich und entweder die Schulung oder den Kursleiter für eine Zusammenfassung aus.
...
* Warteliste - Anzahl
* Benutzer-E-Mails in Warteliste

## Bericht zur Auslastung der Kursleiter
...
Wählen Sie einen oder mehrere Kursleiter und den Datumsbereich aus.
...
* Kursleiter-ID
* Kompetenzniveau
* Datumsangaben in Spalten. Wenn der Kursleiter an einem Datum verwendet wird, wird die Anzahl der Sitzungen aufgeführt. Wenn der Kursleiter nicht an einem Tag verwendet wird, wird der Wert Null angezeigt.

Der Bericht enthält Datensätze für drei Monate ab dem ausgewählten Monat.

Um Datensätze aller Kursleiter abzurufen, lassen Sie das Feld &quot;Kursleiter&quot; leer.

Außerdem kann ein benutzerdefinierter Administrator mit der Berechtigung zum Generieren von Berichten diesen Bericht abrufen.

## Bericht zu Benutzerprüfpfaden
...
Wählen Sie die Teilnehmer oder eine Benutzergruppe aus.
...
* Lernelementtyp(en)
* Lernelement(e)
* Instanz(en) des Lernobjekts
* Lernelement
* Abschlussdatum
* Erinnerung für Lernobjekte
* Bereichskatalog
* Scope-Usergroup
