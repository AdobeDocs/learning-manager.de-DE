...
6. Wählen Sie **+** neben den folgenden Spalten aus, die Sie einschließen möchten. Ausgewählte Spalten werden auf der Berichtsarbeitsfläche angezeigt.
   ...
   * Benutzername
   * Name des Benutzers - Managers
   * Lernobjekt - Name des Lernobjekts
   * Benutzerkonformitätsstatus - Abschluss %
   * Benutzerkompatibilitäts-Status - Kompatibilität %
...
Der heruntergeladene Bericht (CSV) enthält die folgenden Spalten:
...
3. Suchen Sie nach dem Benutzernamen, und wählen Sie **Benutzername** aus.
